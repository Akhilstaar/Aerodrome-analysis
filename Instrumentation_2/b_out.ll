...
define internal void @__cxx_global_var_init() #0 section ".text.startup" !dbg !1073 {
  ...
  %1 = call i32 @__cxa_atexit(ptr @_ZNSt8ios_base4InitD1Ev, ptr @_ZStL8__ioinit, ptr @__dso_handle) #3, !dbg !1076
  ret void, !dbg !1074
}
...
define dso_local noundef ptr @_Z7thrBodyPv(ptr noundef %0) #4 !dbg !1077 {
  ...
  call void @llvm.dbg.declare(metadata ptr %2, metadata !1081, metadata !DIExpression()), !dbg !1082
  call void @llvm.dbg.declare(metadata ptr %3, metadata !1083, metadata !DIExpression()), !dbg !1086
  %5 = load ptr, ptr %2, align 8, !dbg !1087
  store ptr %5, ptr %3, align 8, !dbg !1086
  call void @llvm.dbg.declare(metadata ptr %4, metadata !1088, metadata !DIExpression()), !dbg !1090
  store i64 0, ptr %4, align 8, !dbg !1090
  br label %6, !dbg !1091

6:                                                ; preds = %14, %1
  %7 = load i64, ptr %4, align 8, !dbg !1092
  %8 = icmp ult i64 %7, 100, !dbg !1094
  br i1 %8, label %9, label %17, !dbg !1095

9:                                                ; preds = %6
  %10 = call i32 @pthread_mutex_lock(ptr noundef @mtx) #3, !dbg !1096
  %11 = load i64, ptr @counter, align 8, !dbg !1098
  %12 = add i64 %11, 1, !dbg !1098
  store i64 %12, ptr @counter, align 8, !dbg !1098
  %13 = call i32 @pthread_mutex_unlock(ptr noundef @mtx) #3, !dbg !1099
  br label %14, !dbg !1100

14:                                               ; preds = %9
  %15 = load i64, ptr %4, align 8, !dbg !1101
  %16 = add i64 %15, 1, !dbg !1101
  store i64 %16, ptr %4, align 8, !dbg !1101
  br label %6, !dbg !1102, !llvm.loop !1103
...
define dso_local noundef i32 @main() #7 !dbg !1107 {
  ...
  call void @llvm.dbg.declare(metadata ptr %3, metadata !1110, metadata !DIExpression()), !dbg !1113
  call void @llvm.dbg.declare(metadata ptr %4, metadata !1114, metadata !DIExpression()), !dbg !1115
  call void @llvm.dbg.declare(metadata ptr %5, metadata !1116, metadata !DIExpression()), !dbg !1125
  %8 = call i32 @pthread_attr_init(ptr noundef %5) #3, !dbg !1126
  %9 = call i32 @pthread_attr_setdetachstate(ptr noundef %5, i32 noundef 0) #3, !dbg !1127
  call void @llvm.dbg.declare(metadata ptr %6, metadata !1128, metadata !DIExpression()), !dbg !1130
  call void @llvm.memset.p0.i64(ptr align 2 %6, i8 0, i64 4, i1 false), !dbg !1130
  call void @llvm.dbg.declare(metadata ptr %7, metadata !1131, metadata !DIExpression()), !dbg !1132
  store i32 0, ptr %7, align 4, !dbg !1132
  br label %10, !dbg !1133

10:                                               ; preds = %34, %0
  %11 = load i32, ptr %7, align 4, !dbg !1134
  %12 = icmp ult i32 %11, 2, !dbg !1135
  br i1 %12, label %13, label %37, !dbg !1133

13:                                               ; preds = %10
  %14 = load i32, ptr %7, align 4, !dbg !1136
  %15 = trunc i32 %14 to i16, !dbg !1136
  %16 = load i32, ptr %7, align 4, !dbg !1138
  %17 = zext i32 %16 to i64, !dbg !1139
  %18 = getelementptr inbounds [2 x %struct.thr_args], ptr %6, i64 0, i64 %17, !dbg !1139
  %19 = getelementptr inbounds %struct.thr_args, ptr %18, i32 0, i32 0, !dbg !1140
  store i16 %15, ptr %19, align 2, !dbg !1141
  %20 = load i32, ptr %7, align 4, !dbg !1142
  %21 = zext i32 %20 to i64, !dbg !1143
  %22 = getelementptr inbounds [2 x i64], ptr %3, i64 0, i64 %21, !dbg !1143
  %23 = getelementptr inbounds [2 x %struct.thr_args], ptr %6, i64 0, i64 0, !dbg !1144
  %24 = load i32, ptr %7, align 4, !dbg !1145
  %25 = zext i32 %24 to i64, !dbg !1146
  %26 = getelementptr inbounds %struct.thr_args, ptr %23, i64 %25, !dbg !1146
  %27 = call i32 @pthread_create(ptr noundef %22, ptr noundef %5, ptr noundef @_Z7thrBodyPv, ptr noundef %26) #3, !dbg !1147
  store i32 %27, ptr %2, align 4, !dbg !1148
  %28 = load i32, ptr %2, align 4, !dbg !1149
  %29 = icmp ne i32 %28, 0, !dbg !1151
  br i1 %29, label %30, label %34, !dbg !1152

30:                                               ; preds = %13
  %31 = load i32, ptr %2, align 4, !dbg !1153
  %32 = call ptr @strerror(i32 noundef %31) #3, !dbg !1155
  %33 = call i32 (ptr, ...) @printf(ptr noundef @.str, ptr noundef %32), !dbg !1156
  call void @exit(i32 noundef 1) #11, !dbg !1157
  unreachable, !dbg !1157

34:                                               ; preds = %13
  %35 = load i32, ptr %7, align 4, !dbg !1158
  %36 = add i32 %35, 1, !dbg !1158
  store i32 %36, ptr %7, align 4, !dbg !1158
  br label %10, !dbg !1133, !llvm.loop !1159

37:                                               ; preds = %10
  %38 = call i32 @pthread_attr_destroy(ptr noundef %5) #3, !dbg !1161
  store i32 0, ptr %7, align 4, !dbg !1162
  br label %39, !dbg !1163

39:                                               ; preds = %53, %37
  %40 = load i32, ptr %7, align 4, !dbg !1164
  %41 = icmp ult i32 %40, 2, !dbg !1165
  br i1 %41, label %42, label %56, !dbg !1163

42:                                               ; preds = %39
  %43 = load i32, ptr %7, align 4, !dbg !1166
  %44 = zext i32 %43 to i64, !dbg !1168
  %45 = getelementptr inbounds [2 x i64], ptr %3, i64 0, i64 %44, !dbg !1168
  %46 = load i64, ptr %45, align 8, !dbg !1168
  %47 = call i32 @pthread_join(i64 noundef %46, ptr noundef %4), !dbg !1169
  store i32 %47, ptr %2, align 4, !dbg !1170
  %48 = load i32, ptr %2, align 4, !dbg !1171
  %49 = icmp ne i32 %48, 0, !dbg !1171
  br i1 %49, label %50, label %53, !dbg !1173

50:                                               ; preds = %42
  %51 = load i32, ptr %2, align 4, !dbg !1174
  %52 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %51), !dbg !1176
  call void @exit(i32 noundef 1) #11, !dbg !1177
  unreachable, !dbg !1177

53:                                               ; preds = %42
  %54 = load i32, ptr %7, align 4, !dbg !1178
  %55 = add i32 %54, 1, !dbg !1178
  store i32 %55, ptr %7, align 4, !dbg !1178
  br label %39, !dbg !1163, !llvm.loop !1179

56:                                               ; preds = %39
  %57 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str.2), !dbg !1181
  %58 = load i64, ptr @counter, align 8, !dbg !1182
  %59 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEm(ptr noundef nonnull align 8 dereferenceable(8) %57, i64 noundef %58), !dbg !1183
  %60 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %59, ptr noundef @.str.3), !dbg !1184
  ret i32 0, !dbg !1185
}
...
!178 = !DICompositeType(tag: DW_TAG_structure_type, file: !172, line: 59, size: 64, flags: DIFlagFwdDecl, identifier: "_ZTS5div_t")
...
!482 = !DICompositeType(tag: DW_TAG_structure_type, name: "_IO_FILE", file: !481, line: 4, flags: DIFlagFwdDecl | DIFlagNonTrivial, identifier: "_ZTS8_IO_FILE")
...
!606 = !DICompositeType(tag: DW_TAG_structure_type, name: "tm", file: !472, line: 83, flags: DIFlagFwdDecl | DIFlagNonTrivial, identifier: "_ZTS2tm")
...
!716 = !DICompositeType(tag: DW_TAG_class_type, name: "exception_ptr", scope: !718, file: !717, line: 90, size: 64, flags: DIFlagFwdDecl | DIFlagNonTrivial, identifier: "_ZTSNSt15__exception_ptr13exception_ptrE")
...
!1079 = !{!28, !28}
!1080 = !{}
!1081 = !DILocalVariable(name: "arguments", arg: 1, scope: !1077, file: !10, line: 23, type: !28)
!1082 = !DILocation(line: 23, column: 21, scope: !1077)
!1083 = !DILocalVariable(name: "tmp", scope: !1077, file: !10, line: 25, type: !1084)
!1084 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1085, size: 64)
!1085 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !20)
!1086 = !DILocation(line: 25, column: 28, scope: !1077)
!1087 = !DILocation(line: 25, column: 65, scope: !1077)
!1088 = !DILocalVariable(name: "i", scope: !1089, file: !10, line: 26, type: !67)
!1089 = distinct !DILexicalBlock(scope: !1077, file: !10, line: 26, column: 5)
!1090 = !DILocation(line: 26, column: 19, scope: !1089)
...
!1108 = !DILocalVariable(name: "error", scope: !1107, file: !10, line: 37, type: !41)
!1109 = !DILocation(line: 37, column: 9, scope: !1107)
!1110 = !DILocalVariable(name: "tid", scope: !1107, file: !10, line: 38, type: !1111)
!1111 = !DICompositeType(tag: DW_TAG_array_type, baseType: !1112, size: 128, elements: !94)
!1112 = !DIDerivedType(tag: DW_TAG_typedef, name: "pthread_t", file: !33, line: 27, baseType: !69)
!1113 = !DILocation(line: 38, column: 15, scope: !1107)
!1114 = !DILocalVariable(name: "status", scope: !1107, file: !10, line: 39, type: !28)
!1115 = !DILocation(line: 39, column: 11, scope: !1107)
!1116 = !DILocalVariable(name: "attr", scope: !1107, file: !10, line: 41, type: !1117)
!1117 = !DIDerivedType(tag: DW_TAG_typedef, name: "pthread_attr_t", file: !33, line: 62, baseType: !1118)
!1118 = distinct !DICompositeType(tag: DW_TAG_union_type, name: "pthread_attr_t", file: !33, line: 56, size: 448, flags: DIFlagTypePassByValue, elements: !1119, identifier: "_ZTS14pthread_attr_t")
!1119 = !{!1120, !1124}
!1120 = !DIDerivedType(tag: DW_TAG_member, name: "__size", scope: !1118, file: !33, line: 58, baseType: !1121, size: 448)
!1121 = !DICompositeType(tag: DW_TAG_array_type, baseType: !59, size: 448, elements: !1122)
!1122 = !{!1123}
!1123 = !DISubrange(count: 56)
!1124 = !DIDerivedType(tag: DW_TAG_member, name: "__align", scope: !1118, file: !33, line: 59, baseType: !63, size: 64)
!1125 = !DILocation(line: 41, column: 20, scope: !1107)
!1126 = !DILocation(line: 42, column: 5, scope: !1107)
!1127 = !DILocation(line: 43, column: 5, scope: !1107)
!1128 = !DILocalVariable(name: "args", scope: !1107, file: !10, line: 45, type: !1129)
!1129 = !DICompositeType(tag: DW_TAG_array_type, baseType: !20, size: 32, elements: !94)
!1130 = !DILocation(line: 45, column: 21, scope: !1107)
!1131 = !DILocalVariable(name: "i", scope: !1107, file: !10, line: 47, type: !73)
!1132 = !DILocation(line: 47, column: 14, scope: !1107)
